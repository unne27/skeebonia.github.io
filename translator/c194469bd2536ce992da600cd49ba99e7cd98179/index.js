let english = ['A', 'About', 'All', 'Alert', 'Am', 'And', 'Anything', 'Are', 'Atleast', 'Authorities', 'Avoid', 'Building', 'Discussion', 'Done', 'Ever', 'Government', 'Hello', 'In', 'Information', 'Important', 'Is', 'Know', 'Me', 'Mine', 'More', 'Must', 'Never', 'Not', 'Of', 'Or', 'Our', 'Other', 'Said', 'Say', 'Skeebonia', 'So', 'Swedish', 'To', 'That', 'Than', 'The', 'Them', 'These', 'They', 'Those', 'Though', 'Thorough', 'Through', 'Under', 'Understand', 'Understanding', 'Understatement', 'Very', 'We', 'Why', 'Where', 'Weaponry', 'You', 'Your']
let skeebonian = ['I', 'Jafer', 'Ær', 'Fæðür', 'Zor', 'Shi', 'Tserechi', 'Zar', 'Tarrik', 'Chenðæneri', 'Hürent', 'Ünterzal', 'Œrentich', 'Keð', 'Tsanchi', 'Gzentelmoð', 'Kasching', 'Oer', 'Xetjernai', 'Laeðrænich', 'Tei', 'Mben', 'Mü', 'Müs', 'Ið', 'Bœz', 'Mvender', 'Kœ O.', 'Hæ', 'Bœþür', 'Iztr', 'Nteher', 'Zþan', 'Lætr', 'Skeebonia', 'Læ', 'Sedðes', 'La', 'Ghe', 'Zheþ', 'Ge', 'Đen', 'Ges', 'Đei', 'Gæs', 'Tol', 'Tarnzich', 'Tier', 'Gzech', 'Ürðets', 'Ürðetsin', 'Æþünfrich', 'Tgare', 'Vsach', 'Oib', 'Üchzal', 'Eðesvarn', 'Te', 'Tes']
